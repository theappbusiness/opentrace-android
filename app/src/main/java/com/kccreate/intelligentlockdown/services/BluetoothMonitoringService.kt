package com.kccreate.intelligentlockdown.services
...
import com.kccreate.intelligentlockdown.Preference.isOnBoarded
import com.kccreate.intelligentlockdown.Preference.putLastPurgeTime
import com.kccreate.intelligentlockdown.Utils
import com.kccreate.intelligentlockdown.bluetooth.BLEAdvertiser
import com.kccreate.intelligentlockdown.bluetooth.gatt.ACTION_RECEIVED_STATUS
import com.kccreate.intelligentlockdown.bluetooth.gatt.ACTION_RECEIVED_STREETPASS
import com.kccreate.intelligentlockdown.bluetooth.gatt.STATUS
import com.kccreate.intelligentlockdown.bluetooth.gatt.STREET_PASS
import com.kccreate.intelligentlockdown.idmanager.TempIDManager
import com.kccreate.intelligentlockdown.idmanager.TemporaryID
import com.kccreate.intelligentlockdown.logging.CentralLog
import com.kccreate.intelligentlockdown.notifications.NotificationTemplates
import com.kccreate.intelligentlockdown.permissions.RequestFileWritePermission
import com.kccreate.intelligentlockdown.status.persistence.StatusRecordStorage
import com.kccreate.intelligentlockdown.streetpass.ConnectionRecord
import com.kccreate.intelligentlockdown.streetpass.StreetPassScanner
import com.kccreate.intelligentlockdown.streetpass.StreetPassServer
import com.kccreate.intelligentlockdown.streetpass.StreetPassWorker
...
import com.kccreate.intelligentlockdown.status.Status
...
//            Utils.startBluetoothMonitoringService(applicationContext)
    ...
    private fun performUserLoginCheck() {
        ...
        if (currentUser == null && isOnBoarded(this)) {
...
//                setupAdvertisingCycles()
    ...
    private fun performPurge() {
        ...
        launch {
            ...
            putLastPurgeTime(context, System.currentTimeMillis())
        }
    }
